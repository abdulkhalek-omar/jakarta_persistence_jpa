...
public class Main {
	...
	public static void main(String[] args) {
		...
		Employee employee1 = new Employee("Omar", "AK", "Java, Kotlin, JPA", 4, 1500.00, generateSalaries(), new Company("MyCompany"), 1L);
		employee1.setEmployeeProfile(new EmployeeProfile("Username", "Password", "email@gmail.com", "Software Engineer", employee1, 1L));
		Employee employee2 = new Employee("Jan", "BK", "C#, C++, .Net Core", 3, 1400.00, List.of(new Salary(54000.00, true)), new Company("MyCompany"), 2L);
		...
		Optional<Employee> retrievedEmployee = employeeService.getEmployeeById(5L);
